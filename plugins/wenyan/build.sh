#!/bin/bash
# Build the wenyan plugin backend binary and place it in the expected location.
...
cp "$BIN_PATH" "$SCRIPT_DIR/backend/plugin_com.swallownote.wenyan"
chmod +x "$SCRIPT_DIR/backend/plugin_com.swallownote.wenyan"

echo "Built: $SCRIPT_DIR/backend/plugin_com.swallownote.wenyan"
