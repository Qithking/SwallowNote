#!/bin/bash
# Build the secret-disk plugin backend binary and place it in the expected location.
...
cp "$BIN_PATH" "$SCRIPT_DIR/backend/plugin_com.swallownote.secret-disk"
chmod +x "$SCRIPT_DIR/backend/plugin_com.swallownote.secret-disk"

echo "Built: $SCRIPT_DIR/backend/plugin_com.swallownote.secret-disk"
