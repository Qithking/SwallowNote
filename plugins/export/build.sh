#!/bin/bash
# Build the export plugin backend binary and place it in the expected location.
...
cp "$BIN_PATH" "$SCRIPT_DIR/backend/plugin_com.swallownote.export"
chmod +x "$SCRIPT_DIR/backend/plugin_com.swallownote.export"

echo "Built: $SCRIPT_DIR/backend/plugin_com.swallownote.export"
