...
/**
 * Typist plugin build configuration.
 *
 * Mirrors plugins/export/vite.config.ts:
 *  - dev: standalone Vite preview
 *  - production: ES module bundle + manifest.json + @swallow-manifest comment
 *
 * The host uses the ES module format and the special @swallow-manifest
 * comment to read plugin metadata without parsing the manifest.json
 * separately.
 */
